...
module.exports = {
	name: "inv",
	description: "Check your inventory or someone else's inventory",
	...
	execute: async function(message, args, prefix, client, [firebase]) {
		...
		if (userData.compact === true) {
			...
			else badgesOrganized = badgesOrganized.join(", ");
			...
			if (userData.donator == 1) badgesOrganized.push("<:goldtier_badge:832251366164267010> Gold Tier");
			if (userData.donator == 2) badgesOrganized.push("<:platinumtier_badge:832251366427852881> Platinum Tier");
			if (badgesOrganized.length == 0) badgesOrganized = "There are no badges";
