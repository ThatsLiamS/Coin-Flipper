	...
	execute: async function(message, args) {
		...
		if (!args[0]) {
			let initialEmbed = new Discord.MessageEmbed()
				...
				.setColor("#cd7f32");
			send.sendChannel({ channel: message.channel, author: message.author }, { embeds: [initialEmbed] });
		}
		else if (args[0] == "flipping" || (args[0] == "coin" && args[1] == "flipping")) {
			const coinFlippingEmbed = new Discord.MessageEmbed()
				...
				.setColor("#D3D3D3");
			send.sendChannel({ channel: message.channel, author: message.author }, { embeds: [coinFlippingEmbed] });
		}
			...
			const currencyEmbed = new Discord.MessageEmbed()
				...
				.setColor("#D3D3D3");
			send.sendChannel({ channel: message.channel, author: message.author }, { embeds: [currencyEmbed] });
		}
			...
			const infoEmbed = new Discord.MessageEmbed()
				...
				.setColor("#D3D3D3");
			send.sendChannel({ channel: message.channel, author: message.author }, { embeds: [infoEmbed] });
		}
		else if (args[0] == "karate") {
			const karateEmbed = new Discord.MessageEmbed()
				...
				.setColor("#D3D3D3");
			send.sendChannel({ channel: message.channel, author: message.author }, { embeds: [karateEmbed] });
		}
		else if (args[0] == "addons" || args[0] == "customaddons") {
			const addonEmbed = new Discord.MessageEmbed()
				...
				.setColor("#D3D3D3");
			send.sendChannel({ channel: message.channel, author: message.author }, { embeds: [addonEmbed] });
		}
		else if (args[0] == "customization" || args[0] == "custom" || args[0] == "config" || args[0] == "admin") {
			const customizationEmbed = new Discord.MessageEmbed()
				...
				.setColor("#D3D3D3");
			send.sendChannel({ channel: message.channel, author: message.author }, { embeds: [customizationEmbed] });
		}
			...
			const onlineEmbed = new Discord.MessageEmbed()
				...
				.setColor("#D3D3D3");
			send.sendChannel({ channel: message.channel, author: message.author }, { embeds: [onlineEmbed] });
		}
		else if (args[0] == "trading" || args[0] == "exchange") {
			const tradingEmbed = new Discord.MessageEmbed()
				...
				.setColor("#D3D3D3");
			send.sendChannel({ channel: message.channel, author: message.author }, { embeds: [tradingEmbed] });
		}
		else {
